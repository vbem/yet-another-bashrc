...
alias .python.unittest='python -m unittest -c -v'
alias .python.unittest.discover='python -m unittest discover -c -v'
...
# integration
PS1=$PS1_RET$PS1_LOC$PS1_SHLVL$PS1_LOGIN$PS1_GRP$PS1_PYVENV$PS1_GIT$PS1_PMT
